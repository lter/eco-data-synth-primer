...
[![](content/images/edi-logo.png){width=1.2in}](https://edirepository.org){fig-alt="Environmental Data Initiative (EDI) logo"}

[![](content/images/LTER-network-logo.png){width=1.2in}](https://lternet.edu){fig-alt="Long Term Ecological Research (LTER) Network Office logo"}

[![](content/images/NEON-NSF-logo.png)](https://neonscience.org){fig-alt="National Ecological Observatory Network (NEON) logo"}
