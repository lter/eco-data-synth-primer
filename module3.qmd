...
- If reproducibility is of interest or concern, publish the code or workflow used to process or analyze the data, or to generate research results (like figures).
- Always publish descriptive metadata about any of the above.

In the activity below we will browse a few published dataset to get a feel for what useful data does and doesn't look like. You can also look at advice from a repository like [EDI](https://edirepository.org/resources/designing-a-data-package), or from a research network like [NEON](https://www.neonscience.org/data-samples/guidelines-policies/publishing-research-outputs).
