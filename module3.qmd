...
There are three interconnected elements to a synthesis project (or any research project, really): the data, the analytical workflow, and the results. Each of these elements should reference the others.
...
## Activity: Evaluate 2 synthesis projects
