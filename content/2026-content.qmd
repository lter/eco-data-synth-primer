...
The LTER Network has developed a [template AI use tracker](https://docs.google.com/spreadsheets/d/1HI4sJw3UiKjNFhL8GZai5wlJGoxAdAiNKqT7xLd5FXY/edit?gid=0#gid=0) that may serve as a useful starting point for _recording_ how your group uses AI. Note that this should be used **after your group has already agreed on _how_ to use AI tools!**
...
Top-level folders are colored <span style="color:#209ACA">**blue**</span> so that the high-level structure is easier to quickly scan.
...
|&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;└ - {{< fa file-csv >}} 03_data-filtered.csv  
|&nbsp;&nbsp;&nbsp;|--&nbsp; {{< fa folder >}} climate  
|&nbsp;&nbsp;&nbsp;└ - {{< fa folder >}} land-cover  
|--&nbsp; <span style="color:#209ACA">{{< fa folder >}} **notes**</span>   
|--&nbsp; <span style="color:#209ACA">{{< fa folder >}} **presentations**</span>  
└ - <span style="color:#209ACA">{{< fa folder >}} **publications**</span>   
...
|&nbsp;&nbsp;&nbsp;└ - {{< fa file-code >}} 05_graph.R  
|--&nbsp; <span style="color:#209ACA">{{< fa folder >}} **tools**</span>  
|&nbsp;&nbsp;&nbsp;|--&nbsp; {{< fa file-lines >}} README.md  
|&nbsp;&nbsp;&nbsp;|--&nbsp; {{< fa file-code >}} fxn_calc-beta-diversity.R  
|&nbsp;&nbsp;&nbsp;└ - {{< fa file-code >}} fxn_bookmark-graph.R   
└ - <span style="color:#209ACA">{{< fa folder >}} **explore**</span>  
&nbsp;&nbsp;&nbsp;&nbsp;|--&nbsp; {{< fa file-lines >}} README.md  
&nbsp;&nbsp;&nbsp;&nbsp;|--&nbsp; {{< fa file-code >}} downs-stats.py  
&nbsp;&nbsp;&nbsp;&nbsp;└ - {{< fa file-code >}} lyon-graphs.R  
</div>
:::
::::
