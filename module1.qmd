...
<img src="images/LTER_Survey-2_benefit-importance.png" alt="importance of various benefits to working group participants" style="float: right; padding: 10px; width: 50%"/>
...
<img src="images/LTER_Survey-2_benefit-importance.png" alt="importance of various benefits to working group participants" caption="Survey results from 5 corts of LTER-funded synthesis groups to the question: How important is it to you to gain the following potential benefits through participation in the working group?" style="float: right; padding: 10px 10px 10px 10px; width: 50%"/>
...
-  [EDI (LTER)](https://edirepository.org/) 
-  [GenBank (NCBI)](https://www.ncbi.nlm.nih.gov/nuccore/)
-  [National Ecological Observatory Network (NEON)](https://www.neonscience.org/data)
