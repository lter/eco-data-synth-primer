...
![graphic of typical timeline for working group process, with in person work alternating with online interaction](images/LTER-SWG-timeline.png){fig-align="center" width="90%"}
...
Research from organizational development (Horowitz and Hoowitz 2007, Agawal and Wooley, 2018) and the science of team science (Cheruvelil et al. 2014) finds that teams combining members form multiple fields, backgrounds, and functional styles are more creative and produce better results. There's a big caveat, though. They only get those positive results when the team adopts a **learning mindset** and **the collaboration process allows each participant to contribute in the way that works for them.**
...
> What are some types of difference you might seek out among group members?

#### **Some Ideas**

-  Fields/subfields (ecologists, hydrologists, computer scientists, developmental biologists, engineers, etc.)
-  Research approach (modelers, empiricists, humanists, community-engaged researchers)
-  Career stage (early, mid, late)
-  Type of institution/organization (R1, Community college, PUI, management agency, NGO, Tribal organizations, community members, etc.)
-  Emotional IQ
-  Caregiving responsibilities
-  Funding sources
-  Incentives for participating
-  Thinking styles/information processing approach
-  Study system
...
Once you've assembled a team, there are several steps you can take to get the best work out of the combination of people you've assembled. Starting as early as the invitation to join the team, encourage participants to think about what they have to contribute, what they hope to get out of participating, and to be clear about the level of commitment they can make.
