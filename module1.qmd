...
- Woolley, A. W. et al. (2010). [Evidence for a Collective Intelligence Factor in the Performance of Human Groups](https://doi.org/10.1126/science.1193147). Science, 330(6004), 686–688. https://doi.org/10.1126/science.1193147
...
::: {.callout-note title="Time Commitments"}
...
::: {.callout-tip totle="Sample data author outreach email for unpublished dataset" collapse="true"}
...
```{=html}
<iframe width="780" height="500" src="https://docs.google.com/document/d/1PrhX8Yk9oW_sGJeCAs95ylGu7aGcwBsB/edit?usp=sharing&ouid=109813107716810976634&rtpof=true&sd=true" title="Sample spreadsheet for initial data surveying"></iframe>
```
